        ...
        <>
            {user && (
                <button
                    ...
                    className="fixed bottom-3 right-6 z-1000 bg-white opacity-50 text-black p-4 rounded-full shadow-lg hover:scale-110 transition-transform duration-200 group"
                >
